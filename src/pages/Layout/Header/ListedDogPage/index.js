                ...
                >
                  ...
                  >
                    ...
                    <Box
                      ...
                      display={this.props.width === "xs" ? "flex" : ""}
                      justifyContent={
                        this.props.width === "xs" ? "space-between" : ""
                      }
                      paddingLeft={this.props.width === "xs" ? "15px" : "30px"}
                      paddingRight={this.props.width === "xs" ? "15px" : "0px"}
                    >
                      <Box>
                        <img src="http://breed-dev-back.vuwork.com:8082/images/page/pageImages/2/image-1592908143836-Screenshot_6.png" alt="profile-img" height="40px" width="40px" style={{borderRadius: "20px"}}/>
                      </Box>
                      {this.state.is_open === true ? (
